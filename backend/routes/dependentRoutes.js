...
const {
  ...
  uploadDependentDocuments, getDependentDocuments, verifyDependentDocument, deleteDependentDocument,
...
router.post("/", protect, verified, memberStatus, profileCompleted, addDependent);
router.get("/my", protect, getDependents);
router.post("/edit-requests", protect, verified, memberStatus, profileCompleted, setUploadType("dependent-edit-requests"), uploadArray("supportingFiles", 5), createEditRequest);
router.get("/edit-requests/mine", protect, getMyEditRequests);
