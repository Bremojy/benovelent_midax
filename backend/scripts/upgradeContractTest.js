...
must(portalSections.includes('"/superadmin/messages"'), 'SuperAdmin Messages missing from Communications section.');
...
must(portalSections.includes('"/superadmin/feedback"'), 'SuperAdmin Feedback missing from Communications section.');
