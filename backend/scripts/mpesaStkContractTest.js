...
assert(controller.includes('upstream.status === 404'),"Provider 404 diagnostics missing.");
assert(api.includes('API.post("/payments/stk"'),"Frontend canonical STK request missing.");
assert(!api.includes('direct-Render'),"Frontend must not contain a direct-Render payment fallback.");
