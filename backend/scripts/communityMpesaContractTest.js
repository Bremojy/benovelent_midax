...
for (const value of ["/community-assistance", "/community-assistance/:id/payout", "/community-assistance/:id/close", "community_assistance", "enableCommunityAssistance", "payoutCommunity", "closeCommunity"]) {
...
for (const value of ["Enable community M-PESA", "/payments/community-assistance", "Publish to News", "Disburse raised funds", "Close collection"]) {
