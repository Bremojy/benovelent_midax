...
for (const needle of ['["member", "admin"]', 'join-conversation', 'call-user', 'typing', 'seen-message']) if (!socket.includes(needle)) failures.push(`Realtime chat contract missing: ${needle}`);
