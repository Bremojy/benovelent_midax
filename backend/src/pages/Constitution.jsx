    ...
    <main className="constitution-page">
      <section className={`constitution-hero constitution-video-hero ${videoFailed ? "video-failed" : ""}`}>
        ...
        <div className="section-container">
          <span className="page-badge">Benovelent MIDAX</span>

          <h1>Constitution & Governance</h1>

          <p>
            Our Constitution is the foundation of Benovelent Midax. It promotes fairness, transparency, accountability and equal treatment of every member.
          </p>
        </div>
      </section>
      ...
      <section className="constitution-download">
        <div className="section-container">
          ...
          <p>View, download or print the official Benovelent Midax Constitution.</p>
