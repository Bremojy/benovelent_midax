...
export const publishManagedNews = async (id) => (await API.post(`/news/${id}/publish`)).data;
export const unpublishManagedNews = async (id) => (await API.post(`/news/${id}/unpublish`)).data;
