      ...
      <div className="portal-module">
        ...
        <section className="portal-panel">
          ...
          <form onSubmit={saveTransaction} className="portal-form-grid">
            ...
            <label className="portal-field"><span>Category</span><input type="text" value={form.category} onChange={(e) => setForm({ ...form, category: e.target.value })} placeholder="Salary, funeral support, etc." /></label>
