...
export default function AdminDashboard(){
 ...
 <section className="admin-overview-grid">
  ...
  <div className="admin-overview-card"><div className="overview-card-header"><div><span>CONTRIBUTIONS</span><h2>Finance Snapshot</h2></div><div className="overview-icon"><Wallet size={21}/></div></div><div className="overview-mini-grid"><div><span>Monthly Total</span><strong>{money(contrib.totalContribution)}</strong></div><div><span>Average</span><strong>{money(contrib.averageContribution)}</strong></div><div><span>Highest</span><strong>{money(contrib.highestContribution)}</strong></div><div><span>Lowest</span><strong>{money(contrib.lowestContribution)}</strong></div></div></div>
 </section>
