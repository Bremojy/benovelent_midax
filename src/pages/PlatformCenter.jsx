  ...
  return <div className="platform-center">
    <div className="platform-hero">
      ...
      <div className="platform-hero-actions">
        ...
        <button type="button" className="platform-refresh" onClick={() => load()} disabled={loading}><RefreshCw size={18} className={loading ? "spin" : ""}/> Refresh</button>
      </div>
    </div>
    ...
    <div className="platform-tabs">{tabs.map(([key,label,Icon]) => <button type="button" key={key} className={tab===key?"active":""} onClick={()=>changeTab(key)}><Icon size={17}/><span>{label}</span></button>)}</div>
