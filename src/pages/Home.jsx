...
export default function Home() {
  ...
  return (<>
    ...
    <main className="public-modern-page">
      ...
      <div className="quick-pop modern-quick-pop"><span><Sparkles size={14} /> Quick link</span><Link to="/leaders">See our leaders</Link><Link to="/gallery">See our Benevolent gallery collections</Link></div>
    </main>
  </>);
}
