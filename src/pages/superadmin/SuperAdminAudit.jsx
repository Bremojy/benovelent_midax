  ...
  return (
    <DashboardLayout>
      <div className="portal-module audit-page">
        ...
        <section className="portal-panel">
          <div className="audit-section-head audit-directory-head">
            ...
            <div className="audit-filters">
              <input type="text" value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search name, email or member no." aria-label="Search audit coverage" />
        ...
        <section className="portal-panel">
          <div className="audit-section-head">
            <div><span>ACTIVITY LOG</span><h2>Recent audit events</h2><p>Recorded actions across the portal.</p></div>
          </div>
