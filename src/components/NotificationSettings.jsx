...
export default function NotificationSettings() {
  ...
  const enable = async () => {
    ...
    try {
      ...
      if (permission !== "granted") { setStatus("denied"); setMessage("Notifications are not enabled. Open your phone/browser notification settings to allow them for Benevolent Midax."); return; }
  ...
  return (
    <section className="settings-panel notification-settings-panel">
      ...
      <p className="settings-description">Allow Benevolent MIDAX to alert you about messages, calls, finance updates and important announcements even when the installed app is not open.</p>
