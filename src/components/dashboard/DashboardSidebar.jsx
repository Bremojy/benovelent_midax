...
function DashboardSidebar({ role, sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <aside className={sidebarOpen ? "dashboard-sidebar open" : "dashboard-sidebar"} aria-label="Dashboard navigation">
