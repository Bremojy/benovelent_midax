...
const FAQ = [
  ...
  { keys: ["same account another device", "another device login", "logged in elsewhere"], answer: "For security, a successful account login can replace an older server session. When that happens, the older portal is signed out and must log in again." },
